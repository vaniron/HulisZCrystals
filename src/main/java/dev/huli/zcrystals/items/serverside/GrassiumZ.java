...
public class GrassiumZ extends SimplePolymerItem {
    PolymerModelData modelData;
    public GrassiumZ(Settings settings, Item polymerItem){
    ...
    public int getPolymerCustomModelData(ItemStack itemStack, @Nullable ServerPlayerEntity player){
        this.modelData = ZCrystalsServerSide.grassiumZModelData;
    ...
    public ActionResult useOnEntity(ItemStack itemStack, PlayerEntity playerEntity, LivingEntity livingEntity, Hand hand) {
        if(livingEntity instanceof PokemonEntity pokemonEntity){
            if(pokemonEntity.getExposedSpecies().getName().equalsIgnoreCase("decidueye")){
                ...
                playerEntity.giveItemStack(new ItemStack(ZCrystalsServerSide.DECIDIUM_Z));
